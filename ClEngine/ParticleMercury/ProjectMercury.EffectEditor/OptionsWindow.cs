...
namespace ProjectMercury.EffectEditor
{
    ...
    {
	    private Action<ImageOptions> _backgroundImageOptionsCallback;
        ...
        {
            get => uxBackgroundColour.BackColor;
	        set => uxBackgroundColour.BackColor = value;
        }
        ...
        public Action<Color> BackgroundColourPickedCallback { private get; set; }

        /// <summary>
        /// Gets or sets the background image picked callback.
        /// </summary>
        /// <value>The background image picked callback.</value>
        public Action<String> BackgroundImagePickedCallback { private get; set; }

	    /// <summary>
	    /// Gets or sets the background image options callback.
	    /// </summary>
	    /// <value>The background image options callback.</value>
	    public Action<ImageOptions> BackgroundImageOptionsCallback
	    {
		    get => _backgroundImageOptionsCallback;
		    set => _backgroundImageOptionsCallback = value;
	    }
	    ...
	    public Action BackgroundImageClearedCallback { private get; set; }
        ...
        {
            if (uxColourPicker.ShowDialog() == DialogResult.OK)
            {
                uxBackgroundColour.BackColor = uxColourPicker.Color;

	            BackgroundColourPickedCallback?.Invoke(uxColourPicker.Color);
            }
        }
        ...
        {
            if (uxBackgroundImageDialog.ShowDialog() == DialogResult.OK)
            {
	            BackgroundImagePickedCallback?.Invoke(uxBackgroundImageDialog.FileName);
            }
        }
        ...
        {
	        BackgroundImageClearedCallback?.Invoke();
        }
        ...
        {
	        BackgroundImageOptionsCallback?.Invoke(ImageOptions.Stretch);
        }
        ...
        {
	        BackgroundImageOptionsCallback?.Invoke(ImageOptions.Center);
        }
        ...
        {
	        BackgroundImageOptionsCallback?.Invoke(ImageOptions.Tile);
        }
    }
}
