...
namespace ProjectMercury.Emitters
{
    ...
    public class Emitter
    {
        ...
        public int Budget
        {
            ...
            set
            {
                Guard.IsTrue(this.Initialised, "发射器初始化后无法更改Budget.");
        ...
        public float Term
        {
            ...
            set
            {
                Guard.IsTrue(this.Initialised, "发射器初始化后无法更改Term.");
        ...
        {
            Guard.IsTrue(this.Term < float.Epsilon, "Term属性尚未分配有效值.");
            Guard.IsTrue(this.Budget < 1, "Budget属性尚未分配有效值.");
        ...
        public virtual void LoadContent(ContentManager content)
        {
            ...
            if (String.IsNullOrEmpty(this.ParticleTextureAssetName) == false)
            {
                ...
                {
                    string message = String.Format(@"无法加载指定的内容项目 '{0}'
                                                    请检查'ParticleTextureAssetName'属性!",
        ...
        {
            Guard.IsFalse(this.Initialised, "发射器尚未初始化.");
